...
public class FragmentLegalAdvice extends Fragment {
...
//tv_ha_la_7_2
@Bind(R.id.tv_ha_la_7_1)
TextViewEx tv_ha_la_7_1;
    @Bind(R.id.tv_ha_la_7_2)
    TextViewEx tv_ha_la_7_2;
    @Bind(R.id.tv_ha_la_7_3)
    TextViewEx tv_ha_la_7_3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_administrative_7, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);
//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 26;
        dialog = new Dialog(l_context);
        dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setContentView(R.layout.dialog_yesno);

        tv_ha_la_7_1.setText(true);
        tv_ha_la_7_2.setText(true);
        tv_ha_la_7_3.setText(true);
