...
public class FragmentTheEmployeeDisciplineBoard extends Fragment {
    ...
    //tv_ha_tedb_3_7
    @Bind(R.id.tv_ha_tedb_3_7)
    TextViewEx tv_ha_tedb_3_7;
    @Bind(R.id.tv_ha_tedb_3_6)
    TextViewEx tv_ha_tedb_3_6;
    @Bind(R.id.tv_ha_tedb_3_5)
    TextViewEx tv_ha_tedb_3_5;
    @Bind(R.id.tv_ha_tedb_3_4)
    TextViewEx tv_ha_tedb_3_4;
    @Bind(R.id.tv_ha_tedb_3_3)
    TextViewEx tv_ha_tedb_3_3;
    @Bind(R.id.tv_ha_tedb_3_2)
    TextViewEx tv_ha_tedb_3_2;
    @Bind(R.id.tv_ha_tedb_3_1)
    TextViewEx tv_ha_tedb_3_1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_administrative_3, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);
//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 27;
        ...
        tv_ha_tedb_3_7.setText(true);
        tv_ha_tedb_3_6.setText(true);
        tv_ha_tedb_3_5.setText(true);
        tv_ha_tedb_3_4.setText(true);
        tv_ha_tedb_3_3.setText(true);
        tv_ha_tedb_3_2.setText(true);
        tv_ha_tedb_3_1.setText(true);
