...
public class FragmentOthers extends Fragment {
    ...
    Dialog dialog;
    String act = "";
    @Bind(R.id.tv_other_grievance_5_1)
    TextViewEx tvOtherGrievance51;
    @Bind(R.id.tv_other_grievance_5_2)
    TextViewEx tvOtherGrievance52;
    @Bind(R.id.tv_other_grievance_5_3)
    TextViewEx tvOtherGrievance53;
    @Bind(R.id.tv_other_grievance_5_4)
    TextViewEx tvOtherGrievance54;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_grievance_others, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);
//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 16;
...
//        titleCodeOfConduct.setTypeface(tf);
        ...
        tvOtherGrievance51.setText(true);
                tvOtherGrievance52.setText(true);
        tvOtherGrievance53.setText(true);
                tvOtherGrievance54.setText(true);
        return view;
    }
