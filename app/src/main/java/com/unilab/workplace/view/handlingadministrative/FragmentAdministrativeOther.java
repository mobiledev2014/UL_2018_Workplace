...
public class FragmentAdministrativeOther extends Fragment {
    ...
    //tv_ha_ao_9_5
    @Bind(R.id.tv_ha_ao_9_5)
    TextViewEx tv_ha_ao_9_5;

    @Bind(R.id.tv_ha_ao_9_4)
    TextViewEx tv_ha_ao_9_4;
    @Bind(R.id.tv_ha_ao_9_3)
    TextViewEx tv_ha_ao_9_3;
    @Bind(R.id.tv_ha_ao_9_2)
    TextViewEx tv_ha_ao_9_2;
    @Bind(R.id.tv_ha_ao_9_1)
    TextViewEx tv_ha_ao_9_1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_administrative_9, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);

//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 19;
...
//        titleCodeOfConduct.setTypeface(tf);
        ...
        tv_ha_ao_9_5.setText(true);
        tv_ha_ao_9_4.setText(true);
        tv_ha_ao_9_3.setText(true);
        tv_ha_ao_9_2.setText(true);
        tv_ha_ao_9_1.setText(true);
