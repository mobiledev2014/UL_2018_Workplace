...
public class FragmentDivisionalDisciplinaryCommittee extends Fragment {
...
@Bind(R.id.tv_ha_ddc_2_1)
TextViewEx tv_ha_ddc_2_1;
    @Bind(R.id.tv_ha_ddc_2_2)
    TextViewEx tv_ha_ddc_2_2;
    @Bind(R.id.tv_ha_ddc_2_3)
    TextViewEx tv_ha_ddc_2_3;
    @Bind(R.id.tv_ha_ddc_2_4)
    TextViewEx tv_ha_ddc_2_4;
    @Bind(R.id.tv_ha_ddc_2_5)
    TextViewEx tv_ha_ddc_2_5;
    @Bind(R.id.tv_ha_ddc_2_6)
    TextViewEx tv_ha_ddc_2_6;

    @Bind(R.id.tv_ha_ddc_2_7)
    TextViewEx tv_ha_ddc_2_7;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_administrative_2, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);

//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 22;
        dialog = new Dialog(l_context);
        dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setContentView(R.layout.dialog_yesno);

        tv_ha_ddc_2_1.setText(true);
        tv_ha_ddc_2_2.setText(true);
        tv_ha_ddc_2_3.setText(true);
        tv_ha_ddc_2_4.setText(true);
        tv_ha_ddc_2_5.setText(true);
        tv_ha_ddc_2_6.setText(true);
        tv_ha_ddc_2_7.setText(true);
