...
public class FragmentEvidenceHandling extends Fragment {
    ...
    @Bind(R.id.iv_list)
    ImageView ivList;
    @Bind(R.id.text_evidence_4_3)
    TextViewEx text_evidence_4_3;

    //tv_ha_ev_4_5
    @Bind(R.id.tv_ha_ev_4_5)
    TextViewEx tv_ha_ev_4_5;

    @Bind(R.id.tv_ha_ev_4_4)
    TextViewEx tv_ha_ev_4_4;

    @Bind(R.id.tv_ha_ev_4_2)
    TextViewEx tv_ha_ev_4_2;

    @Bind(R.id.tv_ha_ev_4_1)
    TextViewEx tv_ha_ev_4_1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_administrative_4, container, false);
...
//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 24;


        tv_ha_ev_4_5.setText(true);
        tv_ha_ev_4_4.setText(true);
        tv_ha_ev_4_2.setText(true);
        tv_ha_ev_4_1.setText(true);
        text_evidence_4_3.setText(true);
        return view;
    }
    /**
