...
public class FragmentMediationMeeting extends Fragment {
    ...
    Dialog dialog;
    String act = "";
    @Bind(R.id.tv_mediation_3_1)
    TextViewEx tvMediation31;
    @Bind(R.id.tv_mediation_3_2)
    TextViewEx tvMediation32;
    @Bind(R.id.tv_mediation_3_3)
    TextViewEx tvMediation33;
    @Bind(R.id.tv_mediation_3_4)
    TextViewEx tvMediation34;
    @Bind(R.id.tv_mediation_3_5)
    TextViewEx tvMediation35;
    @Bind(R.id.tv_mediation_3_6)
    TextViewEx tvMediation36;
    @Bind(R.id.tv_mediation_3_7)
    TextViewEx tvMediation37;
    @Bind(R.id.tv_mediation_3_8)
    TextViewEx tvMediation38;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_grievance_mediation_meeting, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);

//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 15;
...
//        titleCodeOfConduct.setTypeface(tf);
        ...
        tvMediation31.setText(true);
        tvMediation32.setText(true);
        tvMediation33.setText(true);
        tvMediation34.setText(true);
        tvMediation35.setText(true);
        tvMediation36.setText(true);
        tvMediation37.setText(true);
        tvMediation38.setText(true);
