...
public class FragmentEnforcementOfPenalties extends Fragment {
    ...
    ImageView ivList;
//tv_ha_eop_8_1
    @Bind(R.id.tv_ha_eop_8_1)
    TextViewEx tv_ha_eop_8_1;

    @Bind(R.id.tv_ha_eop_8_2)
    TextViewEx tv_ha_eop_8_2;

    @Bind(R.id.tv_ha_eop_8_3)
    TextViewEx tv_ha_eop_8_3;

    @Bind(R.id.tv_ha_eop_8_4)
    TextViewEx tv_ha_eop_8_4;

    @Bind(R.id.tv_ha_eop_8_5)
    TextViewEx tv_ha_eop_8_5;

    @Bind(R.id.tv_ha_eop_8_6)
    TextViewEx tv_ha_eop_8_6;

    @Bind(R.id.tv_ha_eop_8_7)
    TextViewEx tv_ha_eop_8_7;

    @Bind(R.id.tv_ha_eop_8_8)
    TextViewEx tv_ha_eop_8_8;
    @Bind(R.id.tv_ha_eop_8_9)
    TextViewEx tv_ha_eop_8_9;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_administrative_8, container, false);

        l_context = getActivity();
        ButterKnife.bind(this, view);

//        Log.d(TAG,"Constants.backToPage"+Constants.backToPage);
        Constants.backToPage = 23;
        dialog = new Dialog(l_context);
        dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        dialog.setContentView(R.layout.dialog_yesno);

        tv_ha_eop_8_1.setText(true);
        tv_ha_eop_8_2.setText(true);
        tv_ha_eop_8_3.setText(true);
        tv_ha_eop_8_4.setText(true);
        tv_ha_eop_8_5.setText(true);
        tv_ha_eop_8_6.setText(true);
        tv_ha_eop_8_7.setText(true);
        tv_ha_eop_8_8.setText(true);
        tv_ha_eop_8_9.setText(true);
